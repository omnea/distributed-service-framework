module.exports = {
	...
	REASON_DEATHS_NO_ARRAY: 'Fail to process message headers (x-deaths is not an array): ',
	...
	REASON_CORRUPTED_NORMAL_REJECTION: 'Fail to process message headers (normalRejections.count is not a number): ',
	REASON_NOT_FOUND_ORIGINAL_ROUTE: 'Fail to process message headers (not found original route): ',
	REASON_REJECTED_TOO_MANY_TIMES: (normal, total) => `Message rejected too many times (${normal.count},${total}): `
};
